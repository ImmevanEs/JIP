...
#iterating over the velocity and TSR to find the relation between the power and TSR, power and velocity and power coefficient and TSR
#the goal is to determine the optimal for V and TSR
#the values can be used to find the optimal configuration and get an estimate for the power 
...
for i in range(len(V_arr)): 
    ...
    for i in range(len(TSR_arr)):
        ...
        for i in range(len(phis)):
            F = F_torque(phis[i]*(np.pi/180),TSR*V_val/r2, pitch, pitch)
        ...
        F = f(phis, TSR*V_val/r2, theta1, theta2, theta3, theta4, theta5, delta1, delta2, delta3, delta4, delta5)
...
plt.plot(TSR_arr, P_arr[0], label='Velocity =' +str(V_arr[0]))
plt.plot(TSR_arr, P_arr[1], label='Velocity =' +str(V_arr[1]))
plt.plot(TSR_arr, P_arr[2], label='Velocity =' +str(V_arr[2]))
plt.plot(TSR_arr, P_arr[3], label='Velocity =' +str(V_arr[3]))
plt.plot(TSR_arr, P_arr[4], label='Velocity =' +str(V_arr[4]))
plt.plot(TSR_arr, P_arr[5], label='Velocity =' +str(V_arr[5]))
plt.xlabel('TSR [-]')
plt.ylabel('Power [W]')
plt.suptitle('Power curve versus TSR for different velocities')
plt.legend( bbox_to_anchor=(1.35, 0.5), loc='center right')
plt.show()

#plot for power vs velocity 
plt.plot(V_arr, P_arr.T[0], label='TSR =' + str(TSR_arr[0]))
plt.plot(V_arr, P_arr.T[1], label='TSR =' + str(TSR_arr[1]))
plt.plot(V_arr, P_arr.T[2], label='TSR =' + str(TSR_arr[2]))
plt.plot(V_arr, P_arr.T[3], label='TSR =' + str(TSR_arr[3]))
plt.plot(V_arr, P_arr.T[4], label='TSR =' + str(TSR_arr[4]))
plt.plot(V_arr, P_arr.T[5], label='TSR =' + str(TSR_arr[5]))
plt.xlabel('Velocity [m/s]')
plt.ylabel('Power [W]')
plt.suptitle('Power curve versus velocity for different TSR')
...
plt.plot(TSR_arr, C_P_arr[0], label = 'Velocity =' +str(V_arr[0]))
plt.plot(TSR_arr, C_P_arr[1], label = 'Velocity =' +str(V_arr[1]))
plt.plot(TSR_arr, C_P_arr[2], label = 'Velocity =' +str(V_arr[2]))
plt.plot(TSR_arr, C_P_arr[3], label = 'Velocity =' +str(V_arr[3]))
plt.plot(TSR_arr, C_P_arr[4], label = 'Velocity =' +str(V_arr[4]))
plt.plot(TSR_arr, C_P_arr[5], label = 'Velocity =' +str(V_arr[5]))
plt.xlabel('TSR [-]')
